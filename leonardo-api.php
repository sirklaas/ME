...
class LeonardoAPI {
    ...
    public function generateImage($prompt, $options = []) {
        ...
        $defaults = [
            'prompt' => $prompt,
            'negative_prompt' => 'realistic animal, realistic tiger, realistic wolf, realistic photo, photorealistic, real animal photo, nature documentary, wrong animal, incorrect species, rabbit when should be chameleon, cat when should be tomato, realistic human face, photo of person, man, woman, human body, human skin, close-up, portrait only, headshot, cropped body, blurry, low quality, pixelated, distorted, amateur, poorly lit, deformed, ugly, bad anatomy, extra limbs, missing limbs, floating limbs, disconnected limbs, malformed hands, long neck, duplicate, mutated, mutilated, out of frame, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, bad proportions, gross proportions, watermark, signature, text, logo, no character, empty scene, landscape only, four legs, walking on four legs, animal on all fours',
