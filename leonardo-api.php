...
class LeonardoAPI {
    ...
    public function generateImage($prompt, $options = []) {
        ...
        $defaults = [
            'prompt' => $prompt,
            'negative_prompt' => 'REALISTIC PHOTO, real animal photograph, nature documentary, wildlife photography, photorealistic llama, realistic fur texture, real animal, photograph of animal, zoo photo, safari photo, realistic tiger, realistic wolf, realistic panda, realistic bear, realistic fox, realistic rabbit, professional photography, DSLR photo, camera photo, real world, realistic lighting, realistic shadows, wrong animal, incorrect species, rabbit when should be chameleon, cat when should be tomato, realistic human face, photo of person, man, woman, human body, human skin, close-up, portrait only, headshot, cropped body, blurry, low quality, pixelated, distorted, amateur, poorly lit, deformed, ugly, bad anatomy, extra limbs, missing limbs, floating limbs, disconnected limbs, malformed hands, long neck, duplicate, mutated, mutilated, out of frame, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, bad proportions, gross proportions, watermark, signature, text, logo, no character, empty scene, landscape only, four legs, walking on four legs, animal on all fours, paws, claws, animal feet',
